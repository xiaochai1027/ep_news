...
public class NewService {
    ...
    public static Map<String, List<Map<String,Object>>> homePage(){
        ...
        List<Map<String, Object>> honor = DBUtil.queryForListMap("select id,title,headPic,type,indexs,ctime from `new` where type = 1 order by indexs desc limit 0,6");
        List<Map<String, Object>> news = DBUtil.queryForListMap("select id,title,headPic,type,indexs,ctime from `new` where type = 2 order by indexs desc limit 0,12");
